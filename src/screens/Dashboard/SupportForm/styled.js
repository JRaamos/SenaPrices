...
const statusToneMap = {
    blue: {
        ...
        background: "linear-gradient(180deg, rgba(59,130,246,.08) 0%, rgba(255,255,255,1) 100%)",
        labelBackground: "rgba(59, 130, 246, .14)",
        labelColor: "#1D4ED8",
    },
    green: {
        border: "rgba(34, 197, 94, .24)",
        background: "linear-gradient(180deg, rgba(34,197,94,.08) 0%, rgba(255,255,255,1) 100%)",
        labelBackground: "rgba(34, 197, 94, .14)",
        labelColor: "#15803D",
    },
    red: {
        border: "rgba(239, 68, 68, .24)",
        background: "linear-gradient(180deg, rgba(239,68,68,.08) 0%, rgba(255,255,255,1) 100%)",
        labelBackground: "rgba(239, 68, 68, .14)",
        labelColor: "#B91C1C",
    },
};

const getStatusTone = (color) => statusToneMap[color] || statusToneMap.blue;
...
export const DashboardStatusCard = styled(DashboardCard).attrs({
})`
    border-color: ${props => getStatusTone(props.color).border};
    background: ${props => getStatusTone(props.color).background};
`;

export const DashboardStatusLabel = styled.div.attrs({
})`
    width: fit-content;
    padding: 6px 12px;
    border-radius: 999px;
    background: ${props => getStatusTone(props.color).labelBackground};
    color: ${props => getStatusTone(props.color).labelColor};
    font-size: 11px;
    font-weight: 700;
    line-height: 16px;
...
export const DashboardStatusText = styled.div.attrs({
})`
    margin-top: 12px;
    color: ${props => props.theme.palette.colors.slate};
    font-size: 14px;
