...
export const Radio = ({ checked, value, active, onChange, onPress, label, title, secondary, disabled, children }) => {
        ...
        <>
            <ThemedComponent>
                <FormGroup>
                    ...
                    <FormControlLabel control={<MaterialRadio checked={internalActive}  onChange={action} color={ secondary ? 'secondary' : 'primary' }  />} label={safeLabel} disabled={disabled} />
                </FormGroup>
            </ThemedComponent>
