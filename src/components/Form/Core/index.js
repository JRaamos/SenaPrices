                            ...
                            nextPrint.map((item, key) => <>
                                {
                                    item.separator ? <FormSeparator /> : <FormInput full={item.full} half={item.half} quarter={item.quarter} twenty={item.twenty} key={key} fit={item?.fit} twothree={item?.twothree}>
                                        ...
                                        { !item.custom && item.options && !item?.multi ? <Select required={item?.required || !!item?.validate} multirequired={item?.multirequired} placeholder={item.placeholder} label={item?.label} options={item.options} value={formValue(item.ref)} onChange={val => { changeForm(val, item.ref); scheduleBlur(item); }} disabled={item.disabled || disabled} small={item?.small} dense={item?.dense} surface={item?.surface} /> : null }
                                        ...
                                        { !item.custom && !item.options && !item.formItems && item.mask ? <MaskedInput required={item?.required || !!item?.validate} mask={item.mask} type={item.type} placeholder={item.placeholder} label={item?.label} value={formValue(item.ref)} onChange={e => changeForm(e.target.value, item.ref)} onBlur={() => typeof item?.onBlur === "function" ? item.onBlur(formValue(item.ref)) : null} disabled={item.disabled || disabled} space={item?.space} dense={item?.dense} surface={item?.surface} /> : null }
                                        ...
                                        { !item.custom && !item.options && !item.formItems && !item.mask && !item.passwordValidation && item.type === 'money' ? <CurrencyInput required={item?.required || !!item?.validate} mask={item.mask} type={item.type} placeholder={item.placeholder} label={item?.label} value={formValue(item.ref)} onChange={e => changeForm(e.target.value, item.ref)} onBlur={() => typeof item?.onBlur === "function" ? item.onBlur(formValue(item.ref)) : null} disabled={item.disabled || disabled} dense={item?.dense} surface={item?.surface} /> : null }
                                        ...
                                        { !item.custom && !item.options && !item.formItems && !item.mask && !item.passwordValidation && !customTypes?.includes(item.type) ? <Input required={item?.required || !!item?.validate} type={item.type} placeholder={item.placeholder} label={item?.label} small={item?.small} value={formValue(item.ref)} onChange={e => changeForm(e.target.value, item.ref)} space={item?.space} dense={item?.dense} surface={item?.surface} disabled={item.disabled || disabled} onBlur={() => typeof item?.onBlur === "function" ? item.onBlur(formValue(item.ref)) : null} startIcon={item?.startIcon} onSubmitEditing={item.onSubmitEditing}/> : null }
