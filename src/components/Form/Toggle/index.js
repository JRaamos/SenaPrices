...
export const Toggle = ({ checked, value, active, onChange, onPress, label, title, secondary, disabled, children }) => {
        ...
        <>
            <ThemedComponent>
                <FormGroup>
                    ...
                    <FormControlLabel control={<MaterialSwitch checked={internalActive}  onChange={action} color={ secondary ? 'secondary' : 'primary' }  />} label={safeLabel} disabled={disabled} />
                </FormGroup>
            </ThemedComponent>
